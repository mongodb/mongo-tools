...
func TestDumpAdminSystemProfileAsBackupUser(t *testing.T) {
	...
	// The JS test this replaces shelled out to bsondump and checked only its exit
	// code, so it could not tell profiler data from any other file that happens to
	// parse as BSON. Counting the entries that record this run's own inserts does.
