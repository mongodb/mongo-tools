...
set_goenv() {
    ...
    case $UNAME_S in
        CYGWIN*)
            PREF_GOROOT="c:/golang/go1.17"
            PREF_PATH="/cygdrive/c/golang/go1.17/bin:/cygdrive/c/mingw-w64/x86_64-4.9.1-posix-seh-rt_v3-rev1/mingw64/bin:$PATH"
        ;;
        *)
            PREF_GOROOT="/opt/golang/go1.17"
