...
6. Update the plan (`~/tmp/js-to-go-conversion-plan.md`)

## Committing

- Prefix all commit messages with `TOOLS-4148 `
- New commits: `gt create -a -m "TOOLS-4148 Convert foo.js to Go"`
- Amend current commit: `gt modify -a`
- Auto-fix formatting before committing: `precious tidy -g`
- Lint check: `precious lint -g`
- Do **not** run `gt submit`
