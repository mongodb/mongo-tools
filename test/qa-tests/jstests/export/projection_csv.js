(function() {
  ...
  // Tests running mongoexport exporting to csv using the --projection option.

  jsTest.log('Testing exporting to csv using the --projection option');

  var toolTest = getToolTest('projection_csv');
  ...
  // the export target
  var exportTarget = 'projection_export.csv';
