...
```
MISE_VERSION=$( cat ./scripts/mise-version.txt ) sh etc/mise.run.sh
```
...
when your working directory is in the mongo-tools repo. See [the `mise` docs](https://mise.jdx.dev/)
