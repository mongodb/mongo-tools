...
// indented, parseable JSON with correct field values (from pretty.js).
...
// documents to stdout when no --out flag is given (from stdout.js).
...
// types are rejected (from type_case.js).
