...
type SourceOptions struct {
	...
	OplogNS string              `long:"oplogns" value-name:"<namespace>" description:"specify the namespace in the --from host where the oplog lives " default:"local.oplog.rs" default-mask:"-"`
