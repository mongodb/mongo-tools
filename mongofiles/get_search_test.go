...
// TestRejectsUnknownFlag covers the flag half of mongofiles_invalid.js. Its
// other half, an unknown subcommand, is the "nonsensical command" case of
// TestValidArguments, which reaches ValidateCommand without connecting.
