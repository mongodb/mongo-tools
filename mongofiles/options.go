...
type StorageOptions struct {
	...
	OverwriteLocal bool `long:"overwriteLocal" short:"ol" description:"make get overwrite local files"`

	AllowUnsafeTraversal bool `long:"allowUnsafeTraversal" short:"ut" description:"allow get_regex to download files with path separators"`
