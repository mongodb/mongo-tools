...
// namespacedID builds the _id of a source document. Encoding the source namespace into the _id is
// what lets a restore that sends data to the wrong namespace be detected by content rather than
// only by document counts.
